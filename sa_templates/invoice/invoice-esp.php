		...
		<div id="outer_doc_wrap">
			...
			<div id="doc_header_wrap" class="sticky_header">
				<header id="header_title">
					...
					<span class="header_id"><?php printf( si__( 'Factura %s' ), si_get_invoice_id() ) ?></span>
					...
					<div id="doc_actions">
						...
						<?php
							$payment_string = ( si_has_invoice_deposit() ) ? si__( 'Fianza de Pago' ) : si__( 'Pago de Facturas' );
								?>
					...
					<section id="header_wrap" class="clearfix">
						...
						<div id="header_logo" class="clearfix">
							...
							<header role="banner">
								<div class="header_info">
									<h2 class="doc_type"><?php si_e( 'Factura' ) ?></h2>
							...
							<?php if ( si_get_invoice_status() == 'write-off' ) : ?>
								<span id="status" class="void"><span class="inner_status"><?php si_e( 'Nulo' ) ?></span></span>
							<?php elseif ( ( si_get_invoice_balance() > 0.00 ) && ( si_get_invoice_balance() <= si_get_invoice_payments_total() ) ): ?>
								<span id="status" class="void"><span class="inner_status"><?php si_e( 'En espera del pago' ) ?></span></span>
							<?php elseif ( ! si_get_invoice_balance() ) : ?>
								<span id="status" class="paid"><span class="inner_status"><?php si_e( 'Pagado' ) ?></span></span>
							<?php endif ?>
						</div><!-- #header_logo -->
						...
						<div id="vcards">
							...
							<dl id="doc_address_info">
								<dl class="from_addy">
									<dt>
										<span class="dt_heading"><?php si_e( 'De' ) ?></span>
									</dt>
									<dd>
						...
						<div class="doc_details clearfix">
							...
							<dl class="date">
								<dt><span class="dt_heading"><?php si_e( 'Fecha' ) ?></span></dt>
								<dd><?php si_invoice_issue_date() ?></dd>
							</dl>

							<?php if ( si_get_invoice_id() ) : ?>
								<dl class="invoice_number">
									<dt><span class="dt_heading"><?php si_e( 'Número de factura' ) ?></span></dt>
							...
							<?php if ( si_get_invoice_po_number() ) : ?>
								<dl class="invoice_po_number">
									<dt><span class="dt_heading"><?php si_e( 'Number' ) ?></span></dt>
							...
							<?php if ( si_get_invoice_due_date() ) : ?>
								<dl class="date">
									<dt><span class="dt_heading"><?php si_e( 'Debido factura' ) ?></span></dt>
							...
							<?php if ( si_has_invoice_deposit() ) : ?>
								<dl class="doc_total_with_deposit">
									<dt><span class="dt_heading"><?php si_e( 'Total de la factura' ) ?></span></dt>
									<dd><?php sa_formatted_money( si_get_invoice_total() ) ?></dd>
								</dl>

								<dl class="doc_total">
									<dt><span class="dt_heading"><?php si_e( 'Depósito total' ) ?></span></dt>
							...
							<dl class="doc_total doc_balance">
								<dt><span class="dt_heading"><?php si_e( 'Equilibrio' ) ?></span></dt>
				...
				<dd>
					<?php if ( $data['status_type'] == SI_Notifications::RECORD ) : ?>
						<p>
							...
							<br/><a href="#TB_inline?width=600&height=380&inlineId=notification_message_<?php echo (int) $item_id ?>" id="show_notification_tb_link_<?php echo (int) $item_id ?>" class="thickbox si_tooltip notification_message" title="<?php si_e( 'View Message' ) ?>"><?php si_e( 'Ver Mensaje' ) ?></a>
						</p>
